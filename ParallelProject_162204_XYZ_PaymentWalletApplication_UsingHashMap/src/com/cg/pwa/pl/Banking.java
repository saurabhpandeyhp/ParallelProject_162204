...
public class Banking {
	...
	private static void showAllAccounts() {
		Map<String, AccountHolder> accounts = bank.fetchAllAccounts();
		Map.Entry<String, AccountHolder> account = null;
		Iterator<Map.Entry<String, AccountHolder>> iterator =
	...
	public static void createAccount()
	{
		...
		String accNo = bank.createAccount(accHolder);
	...
	public static void deposit()
	{
		...
		double balance;
		try {
			balance = bank.deposit(userName, Short.parseShort(pin),
	...
	public static void withdraw()
	{
		...
		double balance;
		try {
			balance = bank.withdraw(userName, Short.parseShort(pin),
					Double.parseDouble(amount));
	...
	public static void fundTransfer()
	{
		...
		try {
			boolean flag = bank.fundTransfer(userName, Short.parseShort(pin), acNo,Double.parseDouble(amount));
			if(flag == true)
			{
				System.out.println(amount+" TRANSFERRED to !"+acNo);
				double balance = bank.showBalance(userName, Short.parseShort(pin));
				System.out.println("Your Balance is : "+balance);
			}
		} catch (NumberFormatException | BankingException e) {
			System.out.println(e.getMessage());
